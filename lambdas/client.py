...
def lambda_handler(event: Dict[str, Any], context: object) -> Dict[str, Any]:
    ...
    try:
        ...
        secret_token: str = get_secret('TELEGRAM_SECRET_TOKEN_SSM_PATH')
        received_token: str = event.get('headers', {}).get('X-Telegram-Bot-Api-Secret-Token')
        ...
        file_id: str = body['message']['photo'][-1]['file_id']

        # Create a unique key to ensure this message is processed only once
        idempotency_key: str = f"{chat_id}-{message_id}"
